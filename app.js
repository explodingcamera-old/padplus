...
(function () {
  ...
  var MP = {
      ...
      if (!window.angular) return;
        ...
        userlist: (function () {
 var out = []; for (var i in MP.userList.users) {out.push(MP.seenUsers[MP.userList.users[i]]);} return out;
 })(),

        historyList: MP.historyList,
        stafflist: (function () {
 var out = []; for (var i in MP.session.roomStaff) {out.push(MP.seenUsers[MP.session.roomStaff[i].uid]);} return out;
 })(),

        bannedlist: (function () {
 var out = []; for (var i in MP.session.bannedUsers) {out.push(MP.seenUsers[MP.session.bannedUsers[i].uid]);} return out;
 })(),
        ...
        queueList: (function () {
 var out = []; var j = 1; for (var i in MP.session.queue.users) {out.push({ num: j++, user: MP.findUser(MP.session.queue.users[i]) });} return out;
 })(),
 ...
 console.log('Invalid callback id'); return;
 }
 ...
 console.log('Invalid callback id'); return false;
 }
...
*/
  ...
  MP.emotes["Basic"][ee] = MP.emotes["Basic"][ee] || { url: "https://raw.githubusercontent.com/Ranks/emojione/master/assets/png/" + data[e].unicode + ".png", style: 'max-width: 24px; max-height: 24px;', };
    ...
    loginWithTok: function (token, callback) {
      if (!token) {
 callback('Token argument not set'); return;
 }
 ...
 if (callback) callback(err); return;
    ...
    playlistCreate: function (name, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        ...
        if (err) {
console.log('Could not add playlist: ' + err); if (callback) callback(err, data); return;
}
    ...
    playlistDelete: function (pid, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        ...
        if (err) {
console.log('Could not delete playlist: ' + err); if (callback) callback(err); return;
}
 ...
 if (callback) callback('Playlist already active'); return;
 }
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        ...
        if (err) {
console.log('Could not activate playlist: ' + err); if (callback) callback(err); return;
}
    ...
    playlistAdd: function (pid, cid, pos, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        ...
        if (err) {
 if (callback) callback(err); console.log('Could not add to playlist: ' + err); return;
}
    ...
    playlistRemove: function (pid, cid, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        ...
        if (err) {
 if (callback) callback(err); console.log('Could not remove from playlist: ' + err); return;
}
    ...
    playlistMove: function (pid, cid, index, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        ...
        if (err) {
 if (callback) callback(err); console.log('Could not move song: ' + err); return;
}
    ...
    playlistImport: function (pid, expand, callback) {
      ...
      if (!pid) {
 callback("MissingProps"); return false;
 }
 ...
 callback(err); return;
    ...
    youtubeSearch: function (query, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        MP.togglePlaylistLoading(false);
        if (err) {
 if (callback) callback(err); console.log('Youtube search error: ' + err); return;
}
    ...
    djQueueJoin: function (callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not join waitlist: ' + err); return;
}
    ...
    djQueueLeave: function (callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not leave waitlist: ' + err); return;
}
    ...
    djQueueModAdd: function (uid, position, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not add user to dj queue: ' + err); return;
}
    ...
    djQueueModRemove: function (uid, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not remove user to dj queue: ' + err); return;
}
    ...
    djQueueModMove: function (uid, position, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not move user in dj queue: ' + err); return;
}
    ...
    djQueueModSwap: function (uid1, uid2, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not swap users in dj queue: ' + err); return;
}
    ...
    djQueueLimit: function (limit, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not change the queue limit: ' + err); return;
}
    ...
    privateMessage: function (uid, message, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not send private message: ' + err); return;
}
    ...
    vote: function (voteType, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Cannot vote: ' + err); return;
}
    ...
    banUser: function (uid, duration, reason, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not ban user: ' + err); return;
}
    ...
    unbanUser: function (uid, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Could not unban user: ' + err); return;
}
  ...
  handler: function (e) {
    ...
    setRole: function (uid, role, callback) {
      ...
      obj.id = MP.addCallback(obj.type, function (err, data) {
        if (err) {
 if (callback) callback(err); console.log('Cannot set role: ' + err); return;
}
 ...
 alert("Use email to login, not username"); return;
 }
      ...
      MP.joinRoom(function (err, data) {
        ...
        if (!MP.isLoggedIn()) {
          ...
          MP.loginWithTok(token, function (err, data) {
            if (err) {
 console.log('Token is invalid.'); return;
}
          });
        }
